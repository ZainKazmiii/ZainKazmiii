...
A responsive word puzzle that combines crossword clues with Wordle-style feedback. The project includes grid and keyboard interactions, puzzle-state management, short-lived reward tokens, and a custom puzzle-layout tool.

**Stack:** Next.js, React, JavaScript, CSS, Upstash Redis

### [Coffee Run](https://github.com/ZainKazmiii/coffee-run)

A cross-platform app for coordinating group coffee orders. Hosts can create a run, friends can customize drinks and join through shared links, and the group can track the active order.
...
[LinkedIn](https://www.linkedin.com/in/zain-kazmi-a10077249)
